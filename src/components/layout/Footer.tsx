...
const DEFAULT_FOOTER = {
  logoText: 'Consulting Firm',
  companyDescription:
    "Transforming businesses through strategic consulting and innovative solutions. We help organizations navigate complex challenges and achieve sustainable growth in today's competitive landscape.",
  contactEmail: 'info@consultingfirm.com',
  contactPhone: '+1 (555) 987-6543',
  contactAddress: '1250 Executive Plaza, Suite 400, New York, NY 10017',
  ...
  section2Title: 'Industries',
  section3Title: 'Resources',
  section4Title: 'Legal',
  copyrightText: '© 2024 Consulting Firm. All rights reserved.',
  madeWithText: 'by our expert team',
  socialText: 'Connect with us:',
  social1Href: 'https://twitter.com/consultingfirm',
  social2Href: 'https://facebook.com/consultingfirm',
  social3Href: 'https://instagram.com/consultingfirm',
  social4Href: 'https://linkedin.com/company/consultingfirm',
  social5Href: 'https://github.com/consultingfirm',
} as const;
...
export default function Footer(props: FooterProps) {
      ...
      links: [
        {
          ...
          editableId: 'link-footer-strategy',
        },
        {
          name: 'Digital Transformation',
          href: '/services/digital',
          editableId: 'link-footer-digital',
        },
        {
          name: 'Operations Excellence',
          href: '/services/operations',
          editableId: 'link-footer-operations',
        },
        { name: 'Change Management', href: '/services/change', editableId: 'link-footer-change' },
        { name: 'Risk Assessment', href: '/services/risk', editableId: 'link-footer-risk' },
        {
      ...
      links: [
        {
          ...
          editableId: 'link-footer-financial',
        },
        {
          name: 'Healthcare',
          href: '/industries/healthcare',
          editableId: 'link-footer-healthcare',
        },
        {
          name: 'Technology',
          href: '/industries/technology',
          editableId: 'link-footer-technology',
        },
        {
          name: 'Manufacturing',
        ...
        { name: 'Retail & Consumer', href: '/industries/retail', editableId: 'link-footer-retail' },
        {
          name: 'Energy & Utilities',
          href: '/industries/energy',
          editableId: 'link-footer-energy',
        },
      ],
    },
    {
      ...
      links: [
        { name: 'Case Studies', href: '/case-studies', editableId: 'link-footer-case-studies' },
        {
          ...
          editableId: 'link-footer-whitepapers',
        },
        { name: 'Industry Reports', href: '/resources/reports', editableId: 'link-footer-reports' },
        { name: 'Webinars', href: '/resources/webinars', editableId: 'link-footer-webinars' },
        {
          name: 'Executive Briefings',
          href: '/resources/briefings',
          editableId: 'link-footer-briefings',
        },
        { name: 'Knowledge Center', href: '/knowledge', editableId: 'link-footer-knowledge' },
      ],
    },
    {
      ...
      links: [
        ...
        { name: 'Terms of Service', href: '/terms', editableId: 'link-footer-terms' },
        {
          ...
          editableId: 'link-footer-agreement',
        },
  ...
  const bottomLinks = [
    ...
    { name: 'Partner Portal', href: '/partners', editableId: 'link-footer-partners' },
    { name: 'Client Login', href: '/login', editableId: 'link-footer-login' },
