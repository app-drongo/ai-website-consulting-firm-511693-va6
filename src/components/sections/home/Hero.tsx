...
const DEFAULT_HERO = {
  ...
  titleHighlight: 'strategic consulting excellence',
  description:
    'Partner with industry-leading consultants to unlock growth opportunities, optimize operations, and drive sustainable competitive advantage across your organization.',
  features: [
  ...
  imageAlt: 'Executive team strategic planning session',
  statsLabel1: 'Client Success',
  statsValue1: '98% Satisfaction',
  statsLabel2: 'ROI Delivered',
  statsValue2: 'Average 340%',
} as const;
