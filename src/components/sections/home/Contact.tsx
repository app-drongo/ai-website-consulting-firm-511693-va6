...
const DEFAULT_CONTACT = {
  badge: 'Get Started',
  mainTitle: 'Ready to Transform',
  mainTitleHighlight: 'Your Business?',
  mainDescription:
    "Connect with our senior consultants to discuss your strategic challenges. We'll provide a complimentary assessment and tailored recommendations for your organization.",
  formTitle: 'Schedule Your Consultation',
  formDescription:
    'Complete the form below and our team will contact you within 24 hours to arrange your strategic consultation.',
  submitButton: 'Request Consultation',
  contactSectionTitle: 'Connect With Our Team',
  method1Title: 'Executive Inquiries',
  method1Description: 'Direct line to senior partners',
  method1Contact: 'partners@consultingfirm.com',
  method2Title: 'Business Development',
  method2Description: 'New client consultations',
  method2Contact: '+1 (212) 555-0147',
  method3Title: 'Client Portal',
  method3Description: 'Existing client support',
  method3Contact: 'Available 24/7',
  officesSectionTitle: 'Global Offices',
  office1City: 'New York',
  office1Address: '432 Park Avenue, 28th Floor',
  office1Timezone: 'EST (UTC-5)',
  office2City: 'Chicago',
  office2Address: '875 North Michigan Ave, Suite 3200',
  office2Timezone: 'CST (UTC-6)',
  office3City: 'San Francisco',
  office3Address: '555 California Street, 45th Floor',
  office3Timezone: 'PST (UTC-8)',
  hoursTitle: 'Business Hours',
  hoursWeekdayLabel: 'Monday - Friday',
  hoursWeekdayTime: '8:00 AM - 7:00 PM',
  hoursSaturdayLabel: 'Saturday',
  hoursSaturdayTime: 'By Appointment',
  hoursSundayLabel: 'Sunday',
  hoursSundayTime: 'Emergency Only',
  supportNote: 'C-Suite executives receive priority 24/7 support',
  nameLabel: 'Executive Name *',
  namePlaceholder: 'John Smith',
  emailLabel: 'Business Email *',
  emailPlaceholder: 'j.smith@company.com',
  companyLabel: 'Company/Organization *',
  companyPlaceholder: 'Fortune 500 Company',
  messageLabel: 'Strategic Challenge *',
  messagePlaceholder:
    'Describe your business challenge, transformation goals, or strategic initiative...',
} as const;
